...
const RevenueMiniSummary = ({ percentTarget, percentPnl, pnlTarget, pnlPrice, totalDay }) => {
                ...
                >
                    ...
                    <View>
                        ...
                        >
                            ...
                            >{calculatePercentageOfChange(pnlTarget, pnlPrice)}%</Text>
                            {pnlTarget > pnlPrice ?
                                <Text
                                    style={{
                                        color: '#fff',
                                ...
                                >{calculatePercentageOfChange(pnlPrice, pnlTarget)}%</Text> : null
                            }
                        </View>
                    </View>
                </View>
...
export default RevenueMiniSummary