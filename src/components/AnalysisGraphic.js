...
const AnalysisGraphic = ({ category }) => {
    ...
    const getBudgetPriceWithdrawal = () => {
        const totalBudget = []
        budgets.filter(fBudget => fBudget.budgetCategoryId == category).map(budget => {
            ...
            >
                ...
                >
                    <View>
                        ...
                        >₺{parseFloat(getBudgetPrice(category) + getLotBuySellNew() + getBudgetPriceWithdrawal()).toFixed(2)}</Text>
                    </View>
                    <View
                        style={{
                            display: 'flex',
                    ...
                    >
                        ...
                        <Image
                            ...
                            calculatePercentageOfChange(getBudgetPrice(category), getBudgetPrice(category) + getLotBuySellNew() + getBudgetPriceWithdrawal()) < 0 ? { transform: [{ rotate: "180deg" }] } : null
                            ]}
                        />
                        <Text
                            style={{
                        ...
                        >
                            {calculatePercentageOfChange(getBudgetPrice(category), getBudgetPrice(category) + getLotBuySellNew() + getBudgetPriceWithdrawal()) == 'NaN' ? 0 : calculatePercentageOfChange(getBudgetPrice(category), getBudgetPrice(category) + getLotBuySellNew() + getBudgetPriceWithdrawal())}%
                        </Text>
                    </View>
                </View>
                <BarChart
                    data={calculateForDate(4)}
